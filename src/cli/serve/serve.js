...
function applyConfigOverrides(rawConfig, opts, extraCliOptions) {
  ...
  if (opts.dev) {
    ...
    if (opts.security) {
      ...
      if (!get('opensearch_security.readonly_mode.roles') && process.env.OPENSEARCH_SECURITY_READONLY_ROLE) {

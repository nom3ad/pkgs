...
exports.isRegisteredLocale = isRegisteredLocale;
...
function getLocaleFromFileName(fullFileName) {
  ...
  return (0, _core.normalizeLocale)(basename);
}
 ...
 */
function isRegisteredLocale(locale) {
  const normalizedLocale = (0, _core.normalizeLocale)(locale);
  return translationsRegistry === null || translationsRegistry === void 0 ? void 0 : translationsRegistry.hasOwnProperty(normalizedLocale);
}

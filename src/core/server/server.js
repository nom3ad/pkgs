...
var _workspace_service = require("./workspace/workspace_service");
...
class Server {
  constructor(rawConfigProvider, env, loggingSystem) {
    ...
    this.workspace = new _workspace_service.WorkspaceService(core);
  ...
  async start() {
    ...
    const savedObjectsStart = await this.savedObjects.start({
      opensearch: opensearchStart,
      pluginsInitialized: _classPrivateFieldGet2(this, _pluginsInitialized)
    });

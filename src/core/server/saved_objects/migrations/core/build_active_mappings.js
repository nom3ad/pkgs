 ...
 */
function buildActiveMappings(typeDefinitions, opensearchDashboardsRawConfig) {
  ...
  if (opensearchDashboardsRawConfig !== null && opensearchDashboardsRawConfig !== void 0 && opensearchDashboardsRawConfig.get('savedObjects.permission.enabled')) {
    const principals = {
      properties: {
        users: {
          type: 'keyword'
  ...
  if (opensearchDashboardsRawConfig !== null && opensearchDashboardsRawConfig !== void 0 && opensearchDashboardsRawConfig.get('workspace.enabled')) {
    mergedProperties = validateAndMerge(mapping.properties, {
      workspaces: {
        type: 'keyword'
      }

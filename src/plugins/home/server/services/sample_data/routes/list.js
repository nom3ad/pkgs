  ...
  router.get({
    ...
    const registeredSampleDatasets = sampleDatasets.map(sampleDataset => {
      return {
        ...
        overviewDashboard: sampleDataset.overviewDashboard ? sampleDataset.getDataSourceIntegratedDashboard(dataSourceId, workspaceId) : '',
        appLinks: sampleDataset.appLinks,
        defaultIndex: sampleDataset.defaultIndex ? sampleDataset.getDataSourceIntegratedDefaultIndex(dataSourceId, workspaceId) : '',

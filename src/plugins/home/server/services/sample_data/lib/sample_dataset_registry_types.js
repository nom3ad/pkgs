 ...
 * under the License.
 */
let DatasetStatusTypes = exports.DatasetStatusTypes = /*#__PURE__*/function (DatasetStatusTypes) {
  DatasetStatusTypes["NOT_INSTALLED"] = "not_installed";
  DatasetStatusTypes["INSTALLED"] = "installed";
  DatasetStatusTypes["UNKNOWN"] = "unknown";
  return DatasetStatusTypes;
}({});
let EmbeddableTypes = exports.EmbeddableTypes = /*#__PURE__*/function (EmbeddableTypes) {

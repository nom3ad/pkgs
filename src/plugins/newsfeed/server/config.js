...
const configSchema = exports.configSchema = _configSchema.schema.object({
  ...
  service: _configSchema.schema.object({
    ...
    urlRoot: _configSchema.schema.conditional(_configSchema.schema.contextRef('prod'), _configSchema.schema.literal(true),
    // Point to staging if it's not a production release

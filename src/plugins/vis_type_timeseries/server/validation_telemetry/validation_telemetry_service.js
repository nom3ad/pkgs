      ...
      usageCollection.registerCollector(usageCollection.makeUsageCollector({
        ...
        fetch: async callCluster => {
          try {
            ...
            return {
              failed_validations: (response === null || response === void 0 || (_response$_source = response._source) === null || _response$_source === void 0 || (_response$_source = _response$_source['tsvb-validation-telemetry']) === null || _response$_source === void 0 ? void 0 : _response$_source.failedRequests) || 0
            };
          } catch (err) {
            return {

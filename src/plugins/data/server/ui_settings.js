...
var _types = require("../../../core/server/ui_settings/types");
...
const dataFrameHydrationStrategyOptionLabels = {
  perSource: _i18n.i18n.translate('data.advancedSettings.dataFrameHydrationStrategyPerSourceText', {
    defaultMessage: 'On data source change'
  }),
  perQuery: _i18n.i18n.translate('data.advancedSettings.dataFrameHydrationStrategyPerQueryText', {
    defaultMessage: 'Per query'
  }),
  perResponse: _i18n.i18n.translate('data.advancedSettings.dataFrameHydrationStrategyPerResponseText', {
    defaultMessage: 'Per response'
  }),
  advanced: _i18n.i18n.translate('data.advancedSettings.dataFrameHydrationStrategyAdvancedText', {
...
function getUiSettings(workspaceEnabled) {
  return {
    ...
    defaultIndex: {
      ...
      scope: workspaceEnabled ? _types.UiSettingScope.WORKSPACE : _types.UiSettingScope.GLOBAL
    },
  ...
  "_default_": { "id": "string", "params": {} }
    ...
    [_common.UI_SETTINGS.DATA_WITH_LONG_NUMERALS]: {
      name: _i18n.i18n.translate('data.advancedSettings.data.withLongNumeralsTitle', {
        defaultMessage: 'Extend Numeric Precision'
      }),
      value: true,
      description: _i18n.i18n.translate('data.advancedSettings.data.withLongNumeralsText', {
        defaultMessage: "Turn on for precise handling of extremely large numbers. Turn off to optimize performance when high precision for large values isn't required."
      }),
      schema: _configSchema.schema.boolean()
    },
  ...
  "to": "now"
    ...
    [_common.UI_SETTINGS.QUERY_ENHANCEMENTS_ENABLED]: {
      name: _i18n.i18n.translate('data.advancedSettings.query.enhancements.enableTitle', {
        defaultMessage: 'Enable query enhancements'
      }),
      value: false,
      description: _i18n.i18n.translate('data.advancedSettings.query.enhancements.enableText', {
        defaultMessage: `
    ...
    [_common.UI_SETTINGS.QUERY_DATAFRAME_HYDRATION_STRATEGY]: {
      name: _i18n.i18n.translate('data.advancedSettings.query.dataFrameHydrationStrategyTitle', {
      ...
      type: 'select',
      description: _i18n.i18n.translate('data.advancedSettings.dataFrameHydrationStrategyText', {
    ...
    [_common.UI_SETTINGS.SEARCH_QUERY_LANGUAGE_BLOCKLIST]: {
      name: _i18n.i18n.translate('data.advancedSettings.searchQueryLanguageBlocklistTitle', {
        defaultMessage: 'Additional query languages blocklist'
      }),
      value: ['none'],
      description: _i18n.i18n.translate('data.advancedSettings.searchQueryLanguageBlocklistText', {
    ...
    [_common.UI_SETTINGS.SEARCH_INCLUDE_ALL_FIELDS]: {
      name: _i18n.i18n.translate('data.advancedSettings.searchIncludeAllFieldsTitle', {
        defaultMessage: 'Include all fields in search request'
      }),
      value: false,
      description: _i18n.i18n.translate('data.advancedSettings.searchIncludeAllFieldsText', {
        defaultMessage: `
        <strong>Experimental</strong>:
    ...
    [_common.UI_SETTINGS.SEARCH_MAX_RECENT_DATASETS]: {
      name: _i18n.i18n.translate('data.advancedSettings.searchMaxRecentDatasets', {

...
exports.UI_SETTINGS = exports.DEFAULT_QUERY_LANGUAGE = exports.DEFAULT_QUERY = exports.DEFAULT_DATA = void 0;
...
const DEFAULT_DATA = exports.DEFAULT_DATA = {
  STRUCTURES: {
    ROOT: {
      ...
      type: 'ROOT',
      meta: {
        type: _types.DATA_STRUCTURE_META_TYPES.FEATURE,
        icon: {
          type: 'folderOpen'
        },
...
const DEFAULT_QUERY_LANGUAGE = exports.DEFAULT_QUERY_LANGUAGE = 'kuery';

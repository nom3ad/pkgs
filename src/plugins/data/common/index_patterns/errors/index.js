...
var _missing_index_pattern = require("./missing_index_pattern");
Object.keys(_missing_index_pattern).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _missing_index_pattern[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _missing_index_pattern[key];
    }
  });
});
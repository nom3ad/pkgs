...
const createEnsureDefaultIndexPattern = (uiSettings, onRedirectNoIndexPattern, canUpdateUiSetting) => {
  /**
  ...
  return async function ensureDefaultIndexPattern() {
    ...
    if (patterns.length >= 1) {
      ...
      if (shouldRedirect) return onRedirectNoIndexPattern();else return;
    }
  };
};

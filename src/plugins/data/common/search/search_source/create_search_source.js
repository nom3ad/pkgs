...
const createSearchSource = (indexPatterns, searchSourceDependencies) => async (searchSourceFields = {}) => {
  ...
  if (fields.index && typeof fields.index === 'string' && (!((_fields$query = fields.query) !== null && _fields$query !== void 0 && (_fields$query = _fields$query.dataset) !== null && _fields$query !== void 0 && _fields$query.type) || fields.query.dataset.type === _constants.DEFAULT_DATA.SET_TYPES.INDEX_PATTERN)) {
    fields.index = await indexPatterns.get(fields.index);
  }

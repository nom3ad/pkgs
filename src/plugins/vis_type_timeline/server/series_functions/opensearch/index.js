...
var _fetch_data_source_id = require("../../lib/fetch_data_source_id");
...
var _default = exports.default = new _datasource.default('es', {
  args: [{
    ...
    types: ['string', 'null'],
    // If null, the query will proceed with local cluster
    help: _i18n.i18n.translate('timeline.help.functions.opensearch.args.dataSourceNameHelpText', {
      defaultMessage: 'Specify a data source to query from. This will only work if multiple data sources is enabled'
    })
  }],
  ...
  fn: async function opensearchFn(args, tlConfig) {
    ...
    const dataSourceId = await (0, _fetch_data_source_id.fetchDataSourceIdByName)(config, tlConfig.savedObjectsClient);
    const body = (0, _build_request.default)(config, tlConfig, scriptedFields, opensearchShardTimeout, dataSourceId);
